...
public class MixNaverMap extends NMapActivity{
    ...
    private static final String CLIENT_ID = "053xvRIIM1QH7UviO0yj";
    ...
    private static final NGeoPoint NMAP_LOCATION_DEFAULT = new NGeoPoint(127.480086, 34.968940); // 기본위치
