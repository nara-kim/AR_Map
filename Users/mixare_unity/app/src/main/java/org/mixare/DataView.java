...
public class DataView {
    ...
    public static final int MENU_ITEM_1 = R.string.menu_item_1; //Data Source
    public static final int MENU_ITEM_2 = R.string.menu_item_2; //List View
    public static final int MENU_ITEM_3 = R.string.menu_item_3; //Map View
    public static final int MENU_ITEM_4 = R.string.menu_item_4; //Zoom Level
    public static final int MENU_ITEM_5 = R.string.menu_item_5;
    public static final int MENU_ITEM_6 = R.string.menu_item_6;
    public static final int MENU_ITEM_7 = R.string.menu_item_7; //License
    public static final int MENU_ITEM_8 = R.string.menu_item_8; //Unity
            ...
            // URL 이 할당되지 않았을 경우에는
                ...
                for (DataSource.DATASOURCE source : DataSource.DATASOURCE.values()) {
                    ...
                    if (mixContext.isDataSourceSelected(source)) {
                        ...
                        Toast.makeText(mixContext, "... 데이터 받는 중 ..." + source, Toast.LENGTH_SHORT).show();
                    }
                }
